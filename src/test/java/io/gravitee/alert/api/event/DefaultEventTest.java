...
public class DefaultEventTest {
    ...
    public void shouldSetOrganization() {
        final Event event = new DefaultEvent.Builder(System.currentTimeMillis())
                .type("test")
                .organization("orga#1").build();
    ...
    public void shouldSetOrganizations() {
        ...
        final Event event = new DefaultEvent.Builder(System.currentTimeMillis())
                .type("test")
                .organizations(new HashSet<>(orgas)).build();
    ...
    public void shouldSetAllWhenOrganizationsIsEmpty() {
        final Event event = new DefaultEvent.Builder(System.currentTimeMillis())
                .type("test")
                .organizations(Collections.emptySet()).build();
    ...
    public void shouldSetEnvironments() {
        ...
        final Event event = new DefaultEvent.Builder(System.currentTimeMillis())
                .type("test")
                .environments(new HashSet<>(orgas)).build();
    ...
    public void shouldSetAllWhenEnvironmentsIsEmpty() {
        final Event event = new DefaultEvent.Builder(System.currentTimeMillis())
                .type("test")
                .environments(Collections.emptySet()).build();
