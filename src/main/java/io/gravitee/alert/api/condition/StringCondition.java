...
public class StringCondition extends AbstractCondition implements Filter {
    ...
    public static class FilterBuilder {
        ...
        public StringCondition.FilterBuilder projections(List<Projection> projections) {
            this.projections = projections;
            return this;
        }

        public StringCondition build() {
            return new StringCondition(property, operator, pattern, ignoreCase, projections);
        }
    }
